...
namespace FinalProject2.Controllers
{
    public class TransmissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransmissionID,TransmissionName,TransmissionType")] Transmission transmission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransmissionID,TransmissionName,TransmissionType")] Transmission transmission)
        {
            if (ModelState.IsValid)
            {
