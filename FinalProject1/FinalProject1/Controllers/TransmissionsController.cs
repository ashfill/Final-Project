...
namespace FinalProject1.Controllers
{
    public class TransmissionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TransmissionID,TransmitionManufacturer,TransmissionType")] Transmission transmission)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TransmissionID,TransmitionManufacturer,TransmissionType")] Transmission transmission)
        {
            if (ModelState.IsValid)
            {
