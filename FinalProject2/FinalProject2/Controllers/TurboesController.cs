...
namespace FinalProject2.Controllers
{
    public class TurboesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TurboID,HPRating,TurbineSize")] Turbo turbo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TurboID,HPRating,TurbineSize")] Turbo turbo)
        {
            if (ModelState.IsValid)
            {
