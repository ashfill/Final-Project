...
namespace FinalProject3.Controllers
{
    public class DropDownListController : Controller
    {
        ...
        //public ActionResult Part(string Mun, string mac, string neg, string ran, string rut)
        //{
        //    Names Cool = new Names();

        //    var Part = from p in db.TotalAmounts
        //               select p;
        //    var AllParts = Part;
        //    int TMun = Convert.ToInt32(Mun);
        //    if (Mun != null)
        //        AllParts = Part.Where(x => x.ManufacturerID == TMun);
